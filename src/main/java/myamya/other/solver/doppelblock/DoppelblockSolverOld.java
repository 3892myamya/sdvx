...
public class DoppelblockSolverOld implements Solver {
	...
	public DoppelblockSolverOld(int height, int width, String param) {
	...
	public static void main(String[] args) {
		...
		System.out.println(new DoppelblockSolverOld(height, width, param).solve());
	}
