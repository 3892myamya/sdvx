...
public class SolverWeb extends HttpServlet {
					...
					if (oneMasu.toString().equals("■")) {
						...
						if (field.getArrows()[yIndex][xIndex] != null) {
							sb.append("<text y=\"" + (yIndex * baseSize + baseSize - 4 + margin)
									...
									+ field.getArrows()[yIndex][xIndex].toStringWeb()
									+ "</text>");
						} else {
							String str = "";
							if (oneMasu.toString().equals("・")) {
				...
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					if (field.getMasu()[yIndex][xIndex] == Masu.BLACK) {
						sb.append("<line y1=\""
								...
								+ (xIndex * baseSize + baseSize + baseSize / 2)
								+ "\" y2=\""
								+ ((yIndex + 1) * baseSize + baseSize / 2 + margin)
								+ "\" x2=\""
	...
	static class CreekSolverThread extends AbsSolverThlead {
		...
		public String makeCambus() {
			...
			for (int yIndex = 0; yIndex < field.getYLength(); yIndex++) {
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					if (field.getMasu()[yIndex][xIndex] == Masu.BLACK) {
						sb.append("<rect y=\"" + (yIndex * baseSize + baseSize / 2 + margin)
								+ "\" x=\""
								+ (xIndex * baseSize + baseSize + baseSize / 2)
								+ "\" width=\""
								+ (baseSize)
						...
						sb.append("<text y=\"" + (yIndex * baseSize + baseSize + baseSize / 2 + margin - 4)
								+ "\" x=\""
								+ (xIndex * baseSize + baseSize + baseSize / 2)
								+ "\" font-size=\""
								+ (baseSize - 2)
	...
	static class AquariumSolverThread extends AbsSolverThlead {
		...
		public String makeCambus() {
			...
			sb.append(
					"<svg xmlns=\"http://www.w3.org/2000/svg\" "
							+ "height=\"" + (field.getYLength() * baseSize + 3 * baseSize + margin) + "\" width=\""
							+ (field.getXLength() * baseSize + 3 * baseSize) + "\" >");
			// ヒント描画
			for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
				if (field.getVarticalHints()[xIndex] != null) {
					...
					sb.append("<text y=\"" + (baseSize + margin - 4)
							+ "\" x=\""
							+ (xIndex * baseSize + baseSize + baseSize)
							+ "\" font-size=\""
							+ (baseSize - 2)
			...
			for (int yIndex = 0; yIndex < field.getYLength(); yIndex++) {
				if (field.getHorizonalHints()[yIndex] != null) {
					...
					sb.append("<text y=\"" + (yIndex * baseSize + baseSize + baseSize - 4 + margin)
							+ "\" x=\""
							+ (baseSize)
							+ "\" font-size=\""
							+ (baseSize - 2)
			...
			for (int yIndex = 0; yIndex < field.getYLength(); yIndex++) {
				for (int xIndex = -1; xIndex < field.getXLength(); xIndex++) {
					...
					if (oneYokoWall) {
						sb.append("<rect y=\"" + (yIndex * baseSize + baseSize + margin)
								+ "\" x=\""
								+ (xIndex * baseSize + baseSize + 2 * baseSize)
								+ "\" width=\""
								+ (1)
								+ "\" height=\""
								+ (baseSize)
			...
			for (int yIndex = -1; yIndex < field.getYLength(); yIndex++) {
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					boolean oneTateWall = yIndex == -1 || yIndex == field.getYLength() - 1
							|| field.getTateWall()[yIndex][xIndex];
					if (oneTateWall) {
						sb.append("<rect y=\"" + (yIndex * baseSize + baseSize + baseSize + margin)
								+ "\" x=\""
								+ (xIndex * baseSize + baseSize + baseSize)
								+ "\" width=\""
								+ (baseSize)
		...
		public String makeCambus() {
			...
			for (Entry<Integer, Compass> entry : field.getCompasses().entrySet()) {
				...
				if (entry.getValue().getLeftCnt() != -1) {
					...
					sb.append("<text y=\"" + (yIndex * baseSize + (baseSize * 2 / 3) + margin - 1)
							+ "\" x=\""
							+ (xIndex * baseSize + baseSize)
							+ "\" font-size=\""
							+ (baseSize) / 3
				...
				if (entry.getValue().getUpCnt() != -1) {
					...
					sb.append("<text y=\"" + (yIndex * baseSize + (baseSize / 3) + margin - 1)
							+ "\" x=\""
							+ (xIndex * baseSize + baseSize + (baseSize / 3))
							+ "\" font-size=\""
							+ (baseSize) / 3
				...
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					if (field.getNumbers()[yIndex][xIndex] != null) {
						sb.append("<circle cy=\"" + (yIndex * baseSize + (baseSize / 2) + margin)
								...
								+ (baseSize / 2 - 2)
								+ "\" fill=\""
								+ (field.isBlackNum()[yIndex][xIndex] ? "black" : "white")
								+ "\", stroke=\"black\">"
								+ "</circle>");
						if (field.getNumbers()[yIndex][xIndex] != 0) {
							String numberStr = String.valueOf(field.getNumbers()[yIndex][xIndex]);
	...
	static class DoppelblockSolverThread extends AbsSolverThlead {
		...
		public String makeCambus() {
			...
			sb.append(
					"<svg xmlns=\"http://www.w3.org/2000/svg\" "
							+ "height=\"" + (field.getYLength() * baseSize + 2 * baseSize + baseSize) + "\" width=\""
			...
			for (int yIndex = 0; yIndex < field.getYLength(); yIndex++) {
				for (int xIndex = -1; xIndex < field.getXLength(); xIndex++) {
					...
					if (oneYokoWall) {
						sb.append("<rect y=\"" + (yIndex * baseSize + baseSize)
								+ "\" x=\""
								+ (xIndex * baseSize + 2 * baseSize + baseSize)
								+ "\" width=\""
								+ (1)
								+ "\" height=\""
								+ (baseSize)
			...
			for (int yIndex = -1; yIndex < field.getYLength(); yIndex++) {
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					boolean oneTateWall = yIndex == -1 || yIndex == field.getYLength() - 1;
					if (oneTateWall) {
						sb.append("<rect y=\"" + (yIndex * baseSize + baseSize + baseSize)
								+ "\" x=\""
								+ (xIndex * baseSize + baseSize + baseSize)
								+ "\" width=\""
								+ (baseSize)
		...
		public String makeCambus() {
			...
			for (int yIndex = 0; yIndex < field.getYLength(); yIndex++) {
				...
				sb.append("<circle cy=\"" + (yIndex * baseSize + baseSize + (baseSize / 2))
						+ "\" cx=\""
						+ (field.getXLength() * baseSize + baseSize + baseSize + (baseSize / 2))
						+ "\" r=\""
						+ (baseSize / 2 - 2)
						+ "\" fill=\"white\", stroke=\"black\">"
						+ "</circle>");
			...
			for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
				...
				sb.append("<circle cy=\"" + (field.getYLength() * baseSize + baseSize + (baseSize / 2))
						+ "\" cx=\""
						+ (xIndex * baseSize + baseSize + baseSize + (baseSize / 2))
						+ "\" r=\""
						+ (baseSize / 2 - 2)
				...
				sb.append("<text y=\"" + (field.getYLength() * baseSize + baseSize + baseSize - 4)
						+ "\" x=\""
						+ (xIndex * baseSize + baseSize + baseSize + 2)
						+ "\" font-size=\""
						+ (baseSize - 5)
		...
		public String makeCambus() {
			...
			for (int yIndex = 0; yIndex < field.getYLength(); yIndex++) {
				for (int xIndex = 0; xIndex < field.getXLength() - 1; xIndex++) {
					if (field.getYokoWall()[yIndex][xIndex] == Wall.NOT_EXISTS) {
						sb.append("<line y1=\""
								+ (yIndex * baseSize + baseSize + baseSize / 2)
								+ "\" x1=\""
								+ (xIndex * baseSize + 2 * baseSize + baseSize / 2)
								+ "\" y2=\""
								+ (yIndex * baseSize + baseSize + baseSize / 2)
								+ "\" x2=\""
				...
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					if (field.getTateWall()[yIndex][xIndex] == Wall.NOT_EXISTS) {
						sb.append("<line y1=\""
								...
								+ (xIndex * baseSize + 3 * baseSize - baseSize / 2)
								+ "\" y2=\""
								+ (yIndex * baseSize + baseSize + baseSize + baseSize / 2)
								+ "\" x2=\""
								+ (xIndex * baseSize + 3 * baseSize - baseSize / 2)
								+ "\" stroke-width=\"1\" fill=\"green\"");
						sb.append("stroke=\"green\" ");
				...
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					if (field.getNumbers()[yIndex][xIndex] != null) {
						...
						if (field.getNumbersCand()[yIndex][xIndex].size() == 1
							...
							if (yIndex == 0
									|| !field.getNumbersCand()[yIndex - 1][xIndex].contains(1)) {
								str = "↑";
							} else {
								str = "│";
							}
					...
					if (field.getMark()[yIndex][xIndex] != null) {
						if (field.getMark()[yIndex][xIndex] == Mark.OK) {
							...
							sb.append("<text y=\"" + (yIndex * baseSize + baseSize - 4 + margin)
									...
									+ "black"
									+ "\" lengthAdjust=\"spacingAndGlyphs\">"
									+ field.getMark()[yIndex][xIndex].toString()
									+ "</text>");
						}
					}
				}
				...
				for (int xIndex = 0; xIndex < field.getXLength(); xIndex++) {
					...
					if (field.getMasu()[yIndex][xIndex] == Masu.BLACK) {
						...
						sb.append("<text y=\"" + (yIndex * baseSize + baseSize + margin - 4)
								...
								+ (baseSize - 2)
								+ "\" fill=\""
								+ (field.getFixedMasuSet().contains(pos) ? "black"
										: "green")
								+ "\" lengthAdjust=\"spacingAndGlyphs\">"
								+ (field.getFixedMasuSet().contains(pos) ? "×"
										: field.getMasu()[yIndex][xIndex].toString())
								+ "</text>");
					}
				}
				...
				for (int xIndex = 0; xIndex < field.getXLength() + 1; xIndex++) {
					...
					if (block != null || yIndex == 0 || xIndex == 0) {
						sb.append("<path d=\"M "
								...
								+ " Z\" >"
								+ "</path>");
						if (block != null && pos.getxIndex() < field.getXLength() - 1 && (block.getLeftCnt() != 0
								|| !field.getBlocks()
						...
						sb.append("<path d=\"M "
								...
								+ " Z\" >"
								+ "</path>");
						if (block != null && pos.getyIndex() < field.getYLength() - 1 && (block.getDownCnt() != 0
								|| !field.getBlocks()
			...
			for (int yIndex = 0; yIndex < field.getYLength() + 1; yIndex++) {
				for (int xIndex = -1; xIndex < field.getXLength() + 1; xIndex++) {
					boolean oneYokoWall = yIndex <= 0 || xIndex <= 0 || yIndex >= field.getYLength() + 1
							|| xIndex >= field.getXLength()
							|| field.getYokoWall()[yIndex - 1][xIndex - 1];
					if (oneYokoWall) {
						sb.append("<line y1=\""
								+ (yIndex * baseSize + margin)
								+ "\" x1=\""
			...
			for (int yIndex = -1; yIndex < field.getYLength() + 1; yIndex++) {
				for (int xIndex = 0; xIndex < field.getXLength() + 1; xIndex++) {
					boolean oneTateWall = yIndex <= 0 || xIndex <= 0 || yIndex >= field.getYLength()
							|| xIndex >= field.getXLength() + 1
							|| field.getTateWall()[yIndex - 1][xIndex - 1];
					if (oneTateWall) {
						sb.append("<line y1=\""
								+ (yIndex * baseSize + baseSize + margin)
								+ "\" x1=\""
