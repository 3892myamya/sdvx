package myamya.other.solver.paintarea;
...
public class PaintareaSolver implements Solver {
	...
	public PaintareaSolver(int height, int width, String param) {
	...
	public static void main(String[] args) {
		...
		System.out.println(new PaintareaSolver(height, width, param).solve());
	}
