...
public class MochikoroSolverOld implements Solver {
	...
	public MochikoroSolverOld(int height, int width, String param) {
	...
	public static void main(String[] args) {
		...
		System.out.println(new MochikoroSolverOld(height, width, param).solve());
	}
