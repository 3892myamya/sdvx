...
import myamya.other.solver.cocktail.CocktailSolver.CocktailGenerator;
import myamya.other.solver.cojun.CojunSolver.CojunGenerator;
import myamya.other.solver.context.ContextSolver.ContextGenerator;
...
import myamya.other.solver.koburin.KoburinSolver.KoburinGenerator;
...
import myamya.other.solver.mannequin.MannequinSolver.MannequinGenerator;
...
import myamya.other.solver.squarejam.SquarejamSolver.SquarejamGenerator;
...
import myamya.other.solver.tetrochain.TetrochainSolver.TetrochainGenerator;
...
import myamya.other.solver.voxas.VoxasSolver.VoxasGenerator;
...
public class SudokuGachaWeb extends HttpServlet {
	...
	static class CocktailGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		CocktailGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new CocktailGenerator(height, width);
		}

	}

	static class SblGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		SblGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new SblGenerator(height, width);
		}

	}

	static class DominofieldGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		DominofieldGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new DominofieldGenerator(height, width);
		}

	}

	static class VoxasGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		VoxasGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new VoxasGenerator(height, width);
		}
	...
	static class LollipopsGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		LollipopsGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new LollipopsGenerator(height, width);
		}
	...
	static class ContextGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		ContextGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new ContextGenerator(height, width);
		}
	...
	static class NothreeGeneratorThlead extends GeneratorThlead {
		protected final int height;
		protected final int width;

		NothreeGeneratorThlead(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new NothreeGenerator(height, width);
		}
	...
	static class MukkonnGeneratorThread extends GeneratorThlead {
		protected final int height;
		protected final int width;

		MukkonnGeneratorThread(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new MukkonnGenerator(height, width);
		}
	...
	static class MannequinGeneratorThread extends GeneratorThlead {
		protected final int height;
		protected final int width;

		MannequinGeneratorThread(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new MannequinGenerator(height, width);
		}

	}

	static class TetrochainGeneratorThread extends GeneratorThlead {
		protected final int height;
		protected final int width;

		TetrochainGeneratorThread(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new TetrochainGenerator(height, width);
		}
	...
	static class SquarejamGeneratorThread extends GeneratorThlead {
		protected final int height;
		protected final int width;

		SquarejamGeneratorThread(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new SquarejamGenerator(height, width);
		}

	}

	static class KoburinGeneratorThread extends GeneratorThlead {
		protected final int height;
		protected final int width;

		KoburinGeneratorThread(int height, int width) {
			this.height = height;
			this.width = width;
		}
		...
		@Override
		Generator getGenerator() {
			return new KoburinGenerator(height, width);
		}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (type.equals("sudoku")) {
				...
				t = new CocktailGeneratorThlead(height, width);
			} else if (type.equals("sbl")) {
				t = new SblGeneratorThlead(height, width);
			} else if (type.equals("dominofield")) {
