...
public class HakoiriSolver implements Solver {
	public static class HakoiriGenerator implements Generator {

		static class HakoiriSolverForGenerator extends HakoiriSolver {
			private final int limit;

			public HakoiriSolverForGenerator(Field field, int limit) {
				super(field);
				this.limit = limit;
			}
		...
		public HakoiriGenerator(int height, int width) {
			this.height = height;
			this.width = width;
		}

		public static void main(String[] args) {
			new HakoiriGenerator(10, 10).generate();
		}

		@Override
		public GeneratorResult generate() {
			HakoiriSolver.Field wkField = new HakoiriSolver.Field(height, width,
			...
			while (true) {
				...
				// 解けるかな？
				level = new HakoiriSolverForGenerator(wkField, 100).solve2();
				if (level < 0) {
					// 解けなければやり直し
	...
	public HakoiriSolver(Field field) {
